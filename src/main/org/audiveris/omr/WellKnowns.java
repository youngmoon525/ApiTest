...
public abstract class WellKnowns
{
    ...
    public static final String COMPANY_NAME ="audiveris-master";// ProgramId.COMPANY_NAME;

    /** Application company id: {@value}. */
    public static final String COMPANY_ID = "audiveris-master";//ProgramId.COMPANY_ID;

    /** Application name: {@value}. */
    public static final String TOOL_NAME = "audiveris-master";//ProgramId.PROGRAM_NAME;

    /** Application id: {@value}. */
    public static final String TOOL_ID = "audiveris-master";//ProgramId.PROGRAM_ID;

    /** Application reference: {@value}. */
    public static final String TOOL_REF = "5.1.0";//ProgramId.PROGRAM_VERSION;

    /** Application build: {@value}. */
    public static final String TOOL_BUILD = "5.1.0";//ProgramId.PROGRAM_BUILD;
